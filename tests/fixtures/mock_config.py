...
TEST_BROKER_SS58 = "5FakeBroker1111111111111111111111111111"
TEST_VALIDATOR_SS58 = "5FakeValidator1111111111111111111111111111"
TEST_PAYOUT_COLDKEY_SS58 = "5FakeColdkey1111111111111111111111111111"
TEST_SMART_CONTRACT_SS58 = "5FakeContract1111111111111111111111111111"
# Mining test data addresses (from tests/data/mining/)
TEST_MINER_HOTKEY_SS58 = "5FakeMinerHotkey1111111111111111111111111"
TEST_MINER_COLDKEY_SS58 = "5FakeMinerColdkey1111111111111111111111111"

# Payment test data addresses
TEST_PAYMENT_COLDKEY_SS58 = "5FakePaymentColdkey1111111111111111111111"

# Test sheet IDs
TEST_TRACKER_SHEET_ID = "test-tracker-sheet-123"
TEST_MINING_TRACKER_SHEET_ID = "test-mining-sheet-456"
TEST_PAYMENT_TRACKER_SHEET_ID = "test-payment-sheet-789"
...
def mock_tracker_settings():
    ...
    with patch.dict(
        "os.environ",
        {
            ...
            "PAYMENT_COLDKEY_SS58": TEST_PAYMENT_COLDKEY_SS58,
            "TRACKER_SHEET_ID": TEST_TRACKER_SHEET_ID,
            "MINING_TRACKER_SHEET_ID": TEST_MINING_TRACKER_SHEET_ID,
            "PAYMENT_TRACKER_SHEET_ID": TEST_PAYMENT_TRACKER_SHEET_ID,
