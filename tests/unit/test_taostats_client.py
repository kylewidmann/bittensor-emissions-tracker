...
@pytest.mark.parametrize(
    "address,start_time,end_time,sender,receiver,expected_params",
    [
...
@pytest.mark.parametrize(
    "netuid,delegate,nominator,start_time,end_time,is_transfer,expected_params",
    [
...
@pytest.mark.parametrize(
    "netuid,hotkey,coldkey,start_time,end_time,expected_params",
    [
...
@pytest.mark.parametrize(
    "symbol,timestamp,expected_params",
    [
        (
            "TAO",
            1700000000,
...
def test_get_price_at_timestamp_params(
    ...
    mock_response = Mock()
    mock_response.json.return_value = {
        "data": [{"created_at": "2023-11-15T00:00:00Z", "price": "350.50"}],
        "pagination": {"next_page": None},
    }
    mock_requests_get.return_value = mock_response
...
@pytest.mark.parametrize(
    "symbol,start_time,end_time,expected_params",
    [
        (
            "TAO",
            1700000000,
...
def test_get_prices_in_range_params(
    ...
    mock_response.json.return_value = {
        "data": [
            {"created_at": "2023-11-15T00:00:00Z", "price": "350.50"},
            {"created_at": "2023-11-15T01:00:00Z", "price": "351.00"},
        ],
        "pagination": {"next_page": None},
    }
    mock_requests_get.return_value = mock_response
...
@pytest.mark.parametrize(
    ...
    [
        ("TAO", {"asset": "TAO", "page": 1, "limit": 200}),
    ],
)
def test_get_current_price_params(client, mock_requests_get, symbol, expected_params):
...
def test_get_transfers_returns_empty_on_error(client, mock_requests_get):
    ...
    result = client.get_transfers(
        "5DcjH2Y8eXskQ9cGgoProcS7S6m9FRg7bdMqvZs4VT2gNsR2", 1700000000, 1700100000
    )
