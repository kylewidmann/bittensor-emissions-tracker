"""Unit tests for mining tracker staking emissions processing."""
...
def test_process_mining_staking_emissions(
    ...
    """Test staking emissions processing for mining tracker."""
    ...
    for i, (expected, actual) in enumerate(zip(expected_lots_sorted, actual_lots_sorted)):
        ...
        # Verify source type is STAKING
        assert actual.source_type == SourceType.STAKING, \
            f"Lot {i+1} should have STAKING source type, got {actual.source_type}"
